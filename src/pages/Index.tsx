...
const HeroCarousel = memo(() => {
  ...
  return (
    <div className="relative rounded-2xl overflow-hidden border border-border shadow-2xl shadow-primary/20 will-change-transform">
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-12">
              {trustedBy.map((company, i) => (
                <motion.div 
                  key={company.name} 
                  className="h-8 opacity-50 hover:opacity-100 transition-all duration-300 hover:scale-110"
                  initial={{ opacity: 0, y: 12 }}
                  whileInView={{ opacity: 0.5, y: 0 }}
                  viewport={{ once: true }}
                  transition={{ delay: i * 0.05, duration: 0.3, ease: fastEase }}
                >
                  <img 
                    src={company.logo} 
                    alt={company.name} 
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {categories.map((cat, i) => (
              <motion.div
                ...
                transition={{ duration: 0.35, delay: i * 0.04, ease: fastEase }}
                className="gh-card text-center cursor-pointer group hover:scale-105 hover:-translate-y-1 transition-all duration-200"
              >
      ...
      <section className="py-24 relative border-t border-border overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-50px" }}
            transition={{ duration: 0.4, delay: 0.1, ease: fastEase }}
          >
            <SolvedFeed limit={4} />
          </motion.div>
        </div>
            ...
            <div className="space-y-16 md:space-y-24">
              {steps.map((step, i) => (
                <motion.div
                  ...
                  viewport={{ once: true, margin: "-50px" }}
                  transition={{ duration: 0.45, delay: i * 0.08, ease: fastEase }}
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {features.map((feature, i) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, margin: "-50px" }}
                transition={{ duration: 0.4, delay: i * 0.08, ease: fastEase }}
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {testimonials.map((testimonial, i) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.4, delay: i * 0.06, ease: fastEase }}
                className="gh-card hover:-translate-y-2 hover:scale-[1.01] transition-all duration-200"
              >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4">
                <Link 
                  to="/create-ticket" 
                  className="gh-btn-primary px-10 py-4 text-lg inline-flex items-center gap-2 hover:scale-[1.02] active:scale-[0.98] transition-transform duration-200"
                >
                  Post a Ticket Free
                ...
                <Link 
                  to="/signup" 
                  className="gh-btn-secondary px-10 py-4 text-lg hover:scale-[1.02] active:scale-[0.98] transition-transform duration-200"
                >
                  Create Account
                </Link>
              </div>
