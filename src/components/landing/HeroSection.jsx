...
export function HeroSection() {
    return (<section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 pointer-events-none">
        {floatingIcons.map(({ Icon, className, delay }, index) => (<div key={index} className={`absolute w-14 h-14 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 flex items-center justify-center float ${delay} ${className}`}>
