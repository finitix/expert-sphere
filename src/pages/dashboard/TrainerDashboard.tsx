...
import { Ticket, DollarSign, Star, TrendingUp, Clock, CheckCircle2, MessageSquare, Calendar, ArrowUpRight, Eye, Play, XCircle } from "lucide-react";
            ...
            >
              {requests.map((req) => (
                <motion.div
                  key={req.id}
                  layout
                  className="gh-card hover:border-primary/30 transition-all cursor-pointer"
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className={`chip text-xs ${
                            job.status === "in_progress" ? "chip-primary" : "chip-warning"
                          }`}>
