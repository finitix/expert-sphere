...
function TicketCard({ ticket }: { ticket: typeof recentTickets[0] }) {
  return (
    <GlassCard className="min-w-[300px] md:min-w-[350px] flex-shrink-0">
      <div className="flex items-start justify-between mb-3">
        <span className="chip text-xs">{ticket.category}</span>
        {ticket.solved && (
          <span className="chip-success text-xs flex items-center gap-1">
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      >
        ...
        {[...recentTickets, ...recentTickets].map((ticket, index) => (
