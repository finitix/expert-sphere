  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "scale-in": {
          "0%": { transform: "scale(0.97) translateZ(0)", opacity: "0" },
        ...
        "pulse-glow": {
          ...
          "50%": { opacity: "0.7", transform: "scale(1.02) translateZ(0)" },
        },
        "float": {
      ...
      animation: {
        ...
        "fade-out": "fade-out 0.3s cubic-bezier(0.32, 0.72, 0, 1)",
      ...
      boxShadow: {
        ...
        "glow-secondary": "0 0 20px hsl(var(--secondary) / 0.2)",
        "glow-success": "0 0 20px hsl(var(--success) / 0.2)",
      },
    },
  },
